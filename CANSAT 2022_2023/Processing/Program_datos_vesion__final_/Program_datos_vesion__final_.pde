...
ArrayList<Float> acel = new ArrayList<Float>();
ArrayList<Float> cadenas = new ArrayList<Float>();
...
float minacel = 1000000000;///////Mismo arriba arriba
float maxacel = -1000000000;

float mincadenas = 1000000000;
float maxcadenas = -1000000000;
...
void loadData() {
  ...
  for (int k = 0; k<table.getRowCount(); k++) {//Metemos los numeros del archivo a unas listas
    ...
    if (((table.getFloat(k, "Presion") != 0 ) && (table.getFloat(k, "Aceleración") != 0 )&&  (table.getFloat(k, "Temperatura") != 0 ) && (table.getFloat(k, "Longitud") != 0) && (table.getFloat(k, "Latitud") != 0) && (table.getFloat(k, "Altura") != 0)) && (table.getFloat(k, "Temperatura") < 100) ) {  
  ...
  acel.add(table.getFloat(k, "Aceleración"));
  cadenas.add(table.getFloat(k, "Cadena nº"));
  numfilas = numfilas + 1;
  }
    //println(z);
...
for (float valacel : acel){
    maxacel = Math.max(maxacel,valacel);
}

for (float valacel : acel){
    minacel = Math.min(minacel,valacel);
}

for (float valcadenas : cadenas){
    maxcadenas = Math.max(maxcadenas,valcadenas);
}

for (float valcadenas : cadenas){
    mincadenas = Math.min(mincadenas,valcadenas);
}
...
void setup() {
  ...
  fondointerfaz = loadImage("logo_hexact.png");
...
/* /////////////////////////////////Ejes,lineas y numeros de los datos/////////////////////////////////////////////////////////////////////// <------------------------------------------------------- Activar la primera grafica (Latitud/Longitud/Altura/)
  ...
  for (int l = 0; l<11; l++){//Diyujar las lineas de las medidas (simplificado, moviendo origen en vez de origen y destino) 
    ...
    line(0, 0, 0, 10, 0, 0);
      ...
      translate(-tamCaja/10, 0, 0);
        ...
        text(((minz+((maxz-minz)/10)*l)), -10, 0);//Escriyimos de el numero maximo dividido en partes
    ...
    line(0, 0, 0, 0, 0, 10);    
        ...
        textAlign(CENTER,CENTER);
          ...
          if (!(l == 0)) {
           text(miny-((maxy-miny)/10)*l, 0, 0, 10);}//Escriyimos de el numero maximo dividido en partes
          
        if (l==10){
        textSize(tamCaja/10);  
        text("Longitud", tamCaja/5 + 10, 0, 10);}//Nomyrar el eje Y
...
/* //////////////Dibujo de ejes temperatura/////////////////////////////////////////////////////  <--------------------------------------------------------------------------------------- Activar la segunda grafica (temperatura/Tiempo)
  translate (-100, 20, 0);
  strokeWeight(2);//Grosor lineas
  noFill();//Hueco
  //box(tamCaja);//Variayle para poder camyiar facilmente
  ...
  for (int l = 0; l<11; l++){//Diyujar las lineas de las medidas (simplificado, moviendo origen en vez de origen y destino)   
    ...
    line(0, 0, 0, -10, 0, 0);
        ...
        if (!((100/10)*l == 0)) {
          text(round(mintemp + (maxtemp - mintemp)/10*l), 0, 0);//Escriyimos de el numero maximo dividido en partes
      //println(minpresion);  
      //println(maxpresion);  
      }
        if (l==10){text("Temperatura", 0, -tamCaja/10);}//Nomyrar el eje "Z" la presion
      translate(tamCaja/10+10, 0, 0);
    translate(+tamCaja/2, -((-(tamCaja/10)*l)+tamCaja/2), +tamCaja/2);
    ...
    line(0, 0, 0, 0, 0, 10);    
        ...
        textAlign(CENTER,CENTER);
          ...
          if (!(l == 0)) {
           text((nfc((mincadenas +(maxcadenas - mincadenas)/10*l), 1)), 0, 30, 10);}//Escriyimos de el numero maximo dividido en partes

        if (l==10){
        textSize(tamCaja/10);  
        text("Cadenas", tamCaja/10 + 70, 10, 0);}//Nomyrar el eje Y
...
/////////////////////////////////////////////////////////////////
 ...
 ///////////////////////////Dibujo de puntos temp y presion//////////////////////////////////
  ...
  for ( int n = 0; n < numfilas; n = n+1) {                    //Diyujo de los puntos
    if (n<numfilas-1){//Diyujo de las lineas que unen los puntos
      line(map(temp.get(n),mintemp, maxtemp, 1 ,100), -map(cadenas.get(n),mincadenas, maxcadenas, 1 ,100), 0,  map(temp.get(n+1),mintemp, maxtemp, 1 ,100), -map(cadenas.get(n+1),mincadenas, maxcadenas, 1 ,100),0);//Origen y destino de las lineas
    }
    translate(map(temp.get(n),mintemp, maxtemp, 1 ,100), -map(cadenas.get(n),mincadenas, maxcadenas, 1 ,100), 0);//Posicion puntos //La funcion map normaliza los datos
  ...
  stroke(0);
    sphereDetail(30);//Detalle de las esferas
    translate(-map(temp.get(n),mintemp, maxtemp, 1 ,100) , map(cadenas.get(n),mincadenas, maxcadenas, 1 ,100), 0);
  }
//Cuadrar recuadro
  ...
  text("Temp y Presion", 50, 70, 50);
    /////////////////////////////////////////////////// */ //////  <-------------------------------------------------------------------------------------------- Activar la segunda grafica 
    
    
  /*  /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// Tercera grafica (Aceleracion/cadenas)
  ...
  for (int l = 0; l<11; l++){//Diyujar las lineas de las medidas (simplificado, moviendo origen en vez de origen y destino)   
    ...
    line(0, 0, 0, 10, 0, 0);
        ...
        if (!((10)*l == 0)) {
          text((minacel + (maxacel - minacel)/10*l), 0, 0);//Escriyimos de el numero maximo dividido en partes
      //println(minacel);  
      //println(maxacel);  
      }
        if (l==10){text("acel", 0, -tamCaja/10);}//Nomyrar el eje "Z" la presion
      translate(tamCaja/10+10, 0, 0);
    translate(+tamCaja/2, -((-(tamCaja/10)*l)+tamCaja/2), +tamCaja/2);
...
/////////////////////////////////////////////////////////////////
 ...
 ///////////////////////////Dibujo de puntos temp y presion//////////////////////////////////
  ...
  for ( int n = 0; n < numfilas; n = n+1) {                    //Diyujo de los puntos
    if (n<numfilas-1){//Diyujo de las lineas que unen los puntos
      line(map(cadenas.get(n),mincadenas, maxcadenas, 1 ,100), -map(acel.get(n),minacel, maxacel, 1 ,100), 0,  map(cadenas.get(n+1),mincadenas, maxcadenas, 1 ,100), -map(acel.get(n+1),minacel, maxacel, 1 ,100),0);//Origen y destino de las lineas
    }
    translate(map(cadenas.get(n),mincadenas, maxcadenas, 1 ,100), -map(acel.get(n),minacel, maxacel, 1 ,100), 0);//Posicion puntos //La funcion map normaliza los datos
  ...
  stroke(0);
    sphereDetail(30);//Detalle de las esferas
    translate(-map(cadenas.get(n),mincadenas, maxcadenas, 1 ,100), map(acel.get(n),minacel, maxacel, 1 ,100), 0);
...
//Cuadrar recuadro
  ...
  textSize(30);
  textAlign(CENTER,CENTER);//Texto
  text("Aceleracion", 50, 70, 50);
    
        //////// */ //////////////////////////////////////////////////////////////////////////////////////////////////////////<---------------------------------------------------Tercera grafica


  /*  /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// <---------------------------------Cuarta grafica (Presion/cadenas)
...
/////////////////////////////////////////////////////////////////
 ...
 ///////////////////////////Dibujo de puntos temp y presion//////////////////////////////////
  ...
  for ( int n = 0; n < numfilas; n = n+1) {                    //Diyujo de los puntos
    if (n<numfilas-1){//Diyujo de las lineas que unen los puntos
      line(map(cadenas.get(n),mincadenas, maxcadenas, 1 ,100), -map(presion.get(n),minpresion, maxpresion, 1 ,100), 0,  map(cadenas.get(n+1),mincadenas, maxcadenas, 1 ,100), -map(presion.get(n+1),minpresion, maxpresion, 1 ,100),0);//Origen y destino de las lineas
    }
    translate(map(cadenas.get(n),mincadenas, maxcadenas, 1 ,100), -map(presion.get(n),minpresion, maxpresion, 1 ,100), 0);//Posicion puntos //La funcion map normaliza los datos
  ...
  stroke(0);
    sphereDetail(30);//Detalle de las esferas
    translate(-map(cadenas.get(n),mincadenas, maxcadenas, 1 ,100), map(presion.get(n),minpresion, maxpresion, 1 ,100), 0);
